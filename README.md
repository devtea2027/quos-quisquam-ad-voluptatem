...
[![Build Status](https://travis-ci.org/devtea2027/quos-quisquam-ad-voluptatem.svg?branch=main)](https://travis-ci.org/devtea2027/quos-quisquam-ad-voluptatem)
...
-   it allows us to more easily test API changes across coupled modules, e.g., changes to `istanbul-lib-coverage`
    potentially have an effect on `@devtea2027/quos-quisquam-ad-voluptatem`.
